...
schedule function gm4_trades-1.6:main 1 replace
...
data modify storage gm4:log versions append value {id: "gm4_trades", module: "lib_trades", version: "1.6.X", from: "Balloon Animals"}
